...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Real Estate'); ?></title>
...
<body class="min-h-screen text-gray-900 p-5 bg-[linear-gradient(180deg,#f8fafc,white)]">
    <header class="border-b">
        ...
        <nav class="md:hidden container mx-auto flex items-center justify-between py-4">
            <a href="<?php echo e(route('home')); ?>" class="font-bold text-xl">RealEstate</a>
        ...
        <nav class="hidden md:grid container mx-auto py-4 md:grid-cols-3 md:items-center">
            ...
            <div class="flex items-center justify-center gap-6">
                <a href="<?php echo e(route('properties.index', ['type' => 'rent'])); ?>"><?php echo e(__('Rent')); ?></a>
                <a href="<?php echo e(route('properties.index', ['type' => 'sale'])); ?>"><?php echo e(__('Sale')); ?></a>
                <a href="/admin" class="px-3 py-1 rounded bg-gray-900 text-white"><?php echo e(__('Admin')); ?></a>
            </div>

            
            <div class="flex items-center justify-end gap-3">
                <a href="<?php echo e(route('locale.switch', 'en')); ?>" class="text-sm underline">EN</a>
                <a href="<?php echo e(route('locale.switch', 'sr')); ?>" class="text-sm underline">SR</a>
                <a href="<?php echo e(route('locale.switch', 'ru')); ?>" class="text-sm underline">RU</a>
            </div>
        </nav>
        ...
        <div id="mobileMenu"
            ...
            <div class="container mx-auto py-3 flex flex-col gap-2">
                <a class="py-2" href="<?php echo e(route('properties.index', ['type' => 'rent'])); ?>"><?php echo e(__('Rent')); ?></a>
                <a class="py-2" href="<?php echo e(route('properties.index', ['type' => 'sale'])); ?>"><?php echo e(__('Sale')); ?></a>
                <a class="py-2" href="/admin"><?php echo e(__('Admin')); ?></a>

                <div class="h-px bg-gray-200 my-1"></div>

                <div class="flex items-center gap-3">
                    <span class="text-sm text-gray-500"><?php echo e(__('Language')); ?>:</span>
                    <a href="<?php echo e(route('locale.switch', 'en')); ?>" class="text-sm underline">EN</a>
                    <a href="<?php echo e(route('locale.switch', 'sr')); ?>" class="text-sm underline">SR</a>
                    <a href="<?php echo e(route('locale.switch', 'ru')); ?>" class="text-sm underline">RU</a>
                </div>
...
<?php /**PATH C:\Users\Administrator\Desktop\111\realestate\resources\views/layouts/app.blade.php ENDPATH**/ ?>