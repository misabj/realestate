...
<section class="container mx-auto px-4">
  {{-- ključno: VIŠE NEMA negativnog margina; sada stoji ispod hero-a --}}
  <div class="mt-8 mb-10 md:mt-12 rounded-2xl bg-white/90 backdrop-blur shadow-xl ring-1 ring-black/5 p-4 md:p-6">
    <div class="grid grid-cols-1 lg:grid-cols-[320px_1fr] gap-6">

      {{-- =============== SIDEBAR FILTERI (sticky) =============== --}}
      <aside class="lg:sticky lg:top-24 h-fit rounded-2xl border bg-white">
        <form method="GET" action="{{ route('properties.index') }}" class="p-5 space-y-4" role="search">
          ...
          <div class="grid grid-cols-2 gap-3">
            <div>
              ...
              <input type="number" name="min_price" value="{{ request('min_price') }}"
                     class="w-full px-3 py-2 rounded-lg border" min="0" step="100"/>
            </div>
            <div>
          ...
          <div class="grid grid-cols-2 gap-3">
            <div>
              ...
              <input type="number" name="rooms_min" value="{{ request('rooms_min') }}"
                     class="w-full px-3 py-2 rounded-lg border" min="0"/>
            </div>
            <div>
          ...
          <div class="grid grid-cols-2 gap-3">
            <div>
              ...
              <input type="number" name="area_min" value="{{ request('area_min') }}"
                     class="w-full px-3 py-2 rounded-lg border" min="0" step="5"/>
            </div>
            <div>
          ...
          <div>
            ...
            <select name="sort" class="w-full px-3 py-2 rounded-lg border" onchange="this.form.submit()">
          ...
          <div class="flex gap-2 pt-2">
            ...
            <a href="{{ route('properties.index') }}" class="px-4 py-2 rounded-lg border hover:bg-gray-50">{{ __('Clear') }}</a>
          </div>
        </form>
      </aside>
      {{-- ========================================================== --}}
        ...
        @if($properties->count())
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            @foreach($properties as $p)
              <a href="{{ route('properties.show', $p->slug) }}"
                 class="group relative border rounded-2xl overflow-hidden bg-white shadow-sm hover:shadow-md transition">
          ...
          <div class="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <a href="{{ route('properties.index', ['type' => 'sale']) }}"
               class="block relative rounded-2xl overflow-hidden group shadow-md border bg-center bg-cover aspect-[16/9] md:aspect-[3/1]">
